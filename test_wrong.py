...
python test_wrong.py --embed_dim 128 --ckpt /mnt/home/husiyuan/code/argo_my/ARGO1/baseline/HiVT/xiaohu_Argo/lightning_logs/version_2/checkpoints/epoch=63-step=102975.ckpt
'''
...
from argoDataloader import ArgoverseV1DataloaderTest
from argoDataset import ArgoverseV1Dataset # 不行 trainer自己没定义test_loader
...
if __name__ == '__main__':
    ...
    parser.add_argument('--root', type=str,default='/mnt/home/husiyuan/code/argo_my/ARGO1/data/')
