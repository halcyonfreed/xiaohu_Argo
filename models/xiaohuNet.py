...
class HiVT(pl.LightningModule):
    '''
    forward, train, optimizer, pl特有训练方法, 把train model都包进去！！
    '''
    def __init__(self,
        ...
        self.local_encoder = LocalEncoder(historical_steps=historical_steps,
                                          ...
                                          parallel=parallel)
        self.global_interactor = GraphInteractor(historical_steps=historical_steps,
                                                  embed_dim=embed_dim,
                                                  edge_dim=edge_dim,
                                                  num_modes=num_modes,
                                                  num_heads=num_heads,
    ...
    def add_model_specific_args(parent_parser):
        '''
        staticmethod 不访问成员和属性，只传参！ 节约开销，parser的套路
        '''
